...
/// 绘制 open_drive地图的pipeline
///
const SKY_TEXTURE_SIZE: u32 = 128;

pub struct PipelineOpenDrive {
...
impl PipelineOpenDrive {
    ...
    pub fn update(
        ...
        target_size: Size<u32>, camera: &Camera,
    ) {
        queue.write_buffer(
            &self.uniforms,
            0,
            bytemuck::bytes_of(&Uniforms::new(camera, Color::BLACK)),
        );
    }
...
impl Uniforms {
    pub fn new(camera: &Camera, light_color: Color) -> Self {
